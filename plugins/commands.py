...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🤖  ᴜᴘᴅᴀᴛᴇꜱ  🤖', url="https://t.me/Telugu_machaa")
            ],
            [
                InlineKeyboardButton('♻️  ᴘʟᴇᴀꜱᴇ ꜱʜᴀʀᴇ  ♻️', url=f"https://telegram.me/share/url?url=t.me/Telugu_machaa"),
            ]
            ]
...
async def shortlink(bot, message):
    btn = [[
        ...
        InlineKeyboardButton(text="ᴏᴡɴᴇʀ", url="https://t.me/Telugu_machaa")
        ],[
