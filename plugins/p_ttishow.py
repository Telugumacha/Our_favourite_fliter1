...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('Support', url='https://t.me/telugu_macha_group')
            ]]
            ...
            return
        buttons = [[
                    InlineKeyboardButton('🥷 ʜᴇʟᴘ 🥷', url='https://t.me/telugu_macha_group'),
                    InlineKeyboardButton('♻️ ᴜᴘᴅᴀᴛᴇꜱ ♻️', url='https://t.me/Telugu_machaa')
                 ]]
        reply_markup=InlineKeyboardMarkup(buttons)
