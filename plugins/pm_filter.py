        ...
        if total_results == 0:
            ...
            return await message.reply_text(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [[
                            InlineKeyboardButton('✧ ᴛᴀᴋᴇ ᴍᴏᴠɪᴇ ꜰʀᴏᴍ ʜᴇʀᴇ ✧', url ='https://t.me/telugu_macha_group')
                        ]]
                    )
                )
    ...
    if query.data.startswith("file"):
            ...
            if (AUTH_CHANNEL or REQ_CHANNEL) and not await is_subscribed(client, query):
                ...
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                         [
                          InlineKeyboardButton("🔰  ᴊᴏɪɴ ꜰᴏʀ ᴍᴏᴠɪᴇs​  🔰", url="https://t.me/telugu_macha_group")
                         ]
                        ]
                    )
                )
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                  InlineKeyboardButton('❤️‍🔥 ᴄʜᴀɴɴᴇʟ​ ❤️‍🔥​', url='https://t.me/Telugu_machaa')
                 ]
                ]
            )
        )
        ...
        buttons = [[
           ...
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Telugu_machaa')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='help2')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("ʙᴀᴄᴋ", callback_data="start"),
                    InlineKeyboardButton("ᴄʟᴏsᴇ", url="https://t.me/telugu_macha_group")
                  ]]
            reply_markup = InlineKeyboardMarkup(btn)
            await client.edit_message_media(
                query.message.chat.id, 
